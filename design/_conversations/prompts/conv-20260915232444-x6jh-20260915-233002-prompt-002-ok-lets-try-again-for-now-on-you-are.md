...
- Example filename: stp-004-implement-settings-ui.md- indicate the effort that shodl be set for each plan and implemetation process
...
When an artifact is being produced, always follow the artifact instruction and content format exactly.​‌just acknowledge you undertand how we are goin to work form now on ​‌
